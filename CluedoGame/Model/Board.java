...
public class Board {
    ...
    public static void setup() {
        ...
        for (int row = 0; row < boardLayoutArray.length; row++) {
            for (int col = 0; col < boardLayoutArray[row].length; col++) {
                boardLayoutArray[row][col] = boardForTesting[row][col];
            }
        }
    ...
    /**
     * This is the original board with players. Used to reset the board array on each board instance
     */
    private static String[][] boardForTesting = new String[][]
            {{
                    "-", "-", "-", "-", "-", "-", "-", "-", "-", "G", "-", "-", "-", "-", "W", "-", "-", "-", "-", "-", "-", "-", "-", "-"},
                    {"-", "-", "-", "-", "-", "-", "-", " ", " ", " ", "-", "-", "-", "-", " ", " ", " ", "-", "-", "-", "-", "-", "-", "-"},
                    {"-", "k", "k", "k", "k", "-", " ", " ", "-", "-", "-", "b", "b", "-", "-", "-", " ", " ", "-", "c", "c", "c", "c", "-"},
